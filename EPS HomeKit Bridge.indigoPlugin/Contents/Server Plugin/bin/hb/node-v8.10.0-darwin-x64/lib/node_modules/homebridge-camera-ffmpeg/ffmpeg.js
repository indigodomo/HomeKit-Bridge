...
function FFMPEG(hap, cameraConfig, log, videoProcessor) {
  ...
  this.additionalCommandline = ffmpegOpt.additionalCommandline || ' -tune zerolatency -preset ultrafast';
    ...
    if (requestType == "start") {
      ...
      if (sessionInfo) {
        ...
        //  ' -crf 23'+
          ...
          '&pkt_size=' + packetsize;
// always ignore this if blueiris - add it manually
          // can't need to address/ports
        if(this.audio){
